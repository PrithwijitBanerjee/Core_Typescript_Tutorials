...
var longText = 'Javascript is a single threaded language. In Node JS enviroment, we can run JS on server side enviroment.';
...
var product = 'Apple Smart Watch';
var price = 799.50;
console.log("The product ".concat(product, " is priced at $").concat(price, "."));
// 🔷 Boolean Type:
...
var isDivisibleBy4And8 = function (a) {
    // if(a % 4 === 0 || a % 8 === 0) {
    //     return true;
    // }
    // else {
...
// const integerRange = Number.MAX_SAFE_INTEGER;
